    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-slate-950/70 backdrop-blur-sm p-4 animate-fade-in">
      <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-2xl max-w-lg w-full p-6 sm:p-7 shadow-2xl relative">
        ...
        <div className="flex items-center gap-3 mb-5">
          <div className="w-10 h-10 rounded-xl bg-indigo-50 dark:bg-indigo-950 text-indigo-600 dark:text-indigo-400 flex items-center justify-center text-xl font-bold border border-indigo-100 dark:border-indigo-800">
            🎫
          </div>
          <div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
            <div>
              ...
              >
                ...
                <option value="varios">🛠️ Mantenimiento Varios</option>
              </select>
            </div>
          ...
          <div className="flex gap-3 pt-2">
            ...
            >
              {loading ? "Creando Ticket..." : "Enviar a Mesa ITIL"}
            </button>
          </div>
        </form>
      </div>
